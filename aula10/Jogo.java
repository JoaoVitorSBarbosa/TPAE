...
public class Jogo {
    ...
    private void ajustarSaidas(Ambiente fora, Ambiente anfiteatro, Ambiente cantina, Ambiente laboratorio,  Ambiente escritorio) {
        
        fora.ajustarSaidas(saidas);
    ...
    private void criarAmbientes() {
        ...
        ajustarSaidas(fora, anfiteatro, cantina, laboratorio, escritorio);
    ...
    private boolean processarComando(Comando comando) {
        ...
        if (palavraDeComando.equals("ajuda")) {
            ...
            if (!comando.temSegundaPalavra()) {
                ...
                irParaAmbiente(comando.getSegundaPalavra());
            }
     ...
     */
    private void irParaAmbiente(String direcao) {
